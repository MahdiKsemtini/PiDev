...
class StatController extends AbstractController
{
     ...
     * @param DemandeEmploiRepository $demandeEmploiRepository
     * @param DemandeStageRepository $demandeStageRepository
     ...
     * @return Response
     */
    public function index(DemandeEmploiRepository $demandeEmploiRepository,DemandeStageRepository $demandeStageRepository,ReclamationRepository $reclamationRepository , FreelancerRepository $freelancerRepository,SocieteRepository $societeRepository, OffreStageRepository $offreStageRepository,OffreEmploiRepository $offreEmploiRepository): Response
    {
