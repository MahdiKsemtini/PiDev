...
class OffreEmploiController extends AbstractController
{
     ...
     */
    public function deleteEmploi($id,QuizRepository $quizRepository)
    {
        $em=$this->getDoctrine()->getManager();
     ...
     *
     */
    public function updateExpiration(OffreEmploiRepository $offreEmploiRepository,QuizRepository $quizRepository): Response
    {
