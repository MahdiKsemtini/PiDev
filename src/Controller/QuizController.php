...
class QuizController extends AbstractController
{
     ...
     */
    public function new(Request $request, int $id,SocieteRepository $srepo,OffreEmploiRepository $repo): Response
    {
        $offre=$repo->find($id);
        $quiz = new Quiz();
        ...
        if ($form->isSubmitted()) {
            ...
            $soc=$srepo->find($this->get('session')->get('id'));
            $quiz->setIdSociete($soc->getId());
