...
declare namespace tt {
  ...
  type IncidentViewportResponse = GenericServiceResponse;
  ...
  type SearchResponse = {
    ...
    /**
     * SearchResult list, sorted in descending order by score.
     */
  ...
  type Summary = {
    ...
    /**
     * Number of SearchResults in the response.
     */
    numResults?: number;

    /**
     * Starting offset of the returned SearchResults within the full SearchResult set.
     */
    offset?: number;

    /**
     * Total number of SearchResults found.
     */
    totalResults?: number;

    /**
     * Maximum fuzzy level required to provide SearchResult.
     */
    fuzzyLevel?: number;

    /**
     * Position used to bias the SearchResults: LatLon double
  ...
  type SearchResult = {
    /**
     * Type of SearchResult.Value: One of:
     * POI
     * Street
     * Geography
     * Point Address
    ...
    /**
     * Score of the SearchResult.
     * A larger score means there is a probability
     * that a SearchResult meeting the query criteria is higher.
     */
    score?: number;
    ...
    /**
     * Information about the original data source of the SearchResult.
     */
    info?: string;
    ...
    /**
     * Structured address for the SearchResult.
     */
    address?: Address;

    /**
     * Position of the SearchResult: LatLon
     * Example: 37.819722,-122.478611
     */
    position?: LatLng;
     ...
     * SearchResult on a map.viewport{} object
     */
    viewport?: Viewport;
     ...
     * result on a map defined by minimum and maximum longitudes and latitudes.boundingBox{} object
     */
     ...
     * SearchResult type is equal to "Address Range".
     */
